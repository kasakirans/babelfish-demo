...
namespace Babelfish_Demo
{
    class Program
    {
        ...
        {
            Console.WriteLine("Getting Bablefish RDS DB Connection ...");

            var datasource = @"database-1.cluster-cvddpslnakcr.us-east-2.rds.amazonaws.com";
            var database = "babelfishdemodb_rds";
            ...
            try
            {
                ...
                Console.WriteLine("Connection successful to Bablefish RDS DB!, Press enter key to work with data....");
                Console.ReadLine();
